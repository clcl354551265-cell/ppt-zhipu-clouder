...
/* Background Image with Overlay — for dramatic/cinematic slides */
.bg-image-slide {
    background-color: #0d0d1a; /* Fallback matching image tone */
...
.bg-image-slide.animated-overlay::before {
